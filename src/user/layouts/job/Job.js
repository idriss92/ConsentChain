    ...
    render() {
        return(
            ...
            <div id="vacancy-background-image">
                <img src="https://app.hellotalent.com/vacancy/background?token=75zKPAh4s2XpkDucYYJ4TcflJMO5KCOgIfZvyaKNDF95MsWOMU6ZzF4%2bjAZcnP4pQ4BGxcVPbdJpM2TMTCzssOAY5YQu8oJPQIjVDq3fNNrzan%2b82Pb8LOeB7plyNvOyQgEChA%3d%3d"></img>
            </div>
                ...
                <div id="vacancy-form" className="vacancy-section">
                    ...
                    <div id="application-form">
                        ...
                        <table className="application-form-table">
							<tbody>
                               <tr>
                                <td className="application-form-item-label">
                                    <label for="ApplicationFormItems_0__StringValue">First name</label>
							...
							<tr>
                                <td className="application-form-item-label">
                                    <label for="ApplicationFormItems_1__StringValue">Last name</label>
                                    <span className="application-form-mandatory">*</span>
                                </td>
                                <td className="application-form-item-content">
							...
							<tr>
                                <td className="application-form-item-label">
                                    <label for="ApplicationFormItems_2__EmailValue">Email</label>
                                    <span className="application-form-mandatory">*</span>
                                </td>
                                <td className="application-form-item-content">
						...
						<tr>
                                <td className="application-form-item-label">
                                    <label for="ApplicationFormItems_3__StringValue">Phone number</label>
								...
								<tr>
                                <td className="application-form-item-label">
                                    <label for="ApplicationFormItems_4__StringValue">Comment</label>
							...
							<tr>
                                <td className="application-form-item-label">
                                    <label for="ApplicationFormItems_5__FileValue">Upload your CV</label>
