            ...
            <main id="vacancy" className="container">
                ...
                <div id="vacancy-content">
                    <div id="vacancy-header" className="vacancy-section">
                        ...
                        <div className="likely likely-big likely_visible likely_ready" data-url="https://app.hellotalent.com/vacancy/development-ninja-ed18e378c" data-title="Hello Unicorn recrute un development Ninja. Postulez maintenant !">
                    ...
                    <div id="vacancy-description" className="vacancy-section">
                        ...
                        <ul>
                            <li>Managing all development for the company and activities within the development department.</li>
                            <li>Developing the development strategy for the company in line with company objectives.</li>
                            <li>Co-ordinating development campaigns with sales activities.</li>
                            <li>Overseeing the company’s development budget.</li>
                            <li>Creation and publication of all development material in line with development plans.</li>
                            ...
                            <li>Preparing online and print development campaigns.</li>
                            <li>Monitor and report on effectiveness of development communications.</li>
                            <li>Creating a wide range of different development materials.</li>
                            <li>Working closely with design agencies and assisting with new product launches.</li>
                            <li>Maintain effective internal communications to ensure that all relevant company functions are kept informed of development objectives.</li>
                            <li>Analysing potential strategic partner relationships for company development.</li>
                        </ul>
                    </div>
